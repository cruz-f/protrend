...
class OrganismCommunity(models.Model):
    ...
    species = models.CharField(blank=True, null=True, max_length=150, help_text=help_text.species)
    strain = models.CharField(blank=True, null=True, max_length=150, help_text=help_text.strain)
    ...
    assembly_accession = models.CharField(blank=True, null=True, max_length=50, help_text=help_text.assembly_accession)
