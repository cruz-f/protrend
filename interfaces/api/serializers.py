...
class SequenceMixInSerializer(serializers.Serializer):
    # properties
    sequence = serializers.CharField(help_text=help_text.sequence)
...
class PositionMixInSerializer(serializers.Serializer):
    # properties
    strand = serializers.CharField(choices=choices.strand, help_text=help_text.strand)
    start = serializers.IntegerField(help_text=help_text.start)
    stop = serializers.IntegerField(help_text=help_text.stop)
...
class GeneMixInSerializer(serializers.Serializer):
    ...
    uniprot_accession = serializers.CharField(max_length=50, help_text=help_text.uniprot_accession)
    name = serializers.CharField(max_length=50, help_text=help_text.gene_name)
    synonyms = serializers.ListField(child=serializers.CharField(), help_text=help_text.synonyms)
    function = serializers.CharField(help_text=help_text.function)
    description = serializers.CharField(help_text=help_text.description)
    ncbi_gene = serializers.IntegerField(max_length=50, help_text=help_text.ncbi_gene)
    ncbi_protein = serializers.IntegerField(max_length=50, help_text=help_text.ncbi_protein)
    genbank_accession = serializers.CharField(max_length=50, help_text=help_text.genbank_accession)
    refseq_accession = serializers.CharField(max_length=50, help_text=help_text.refseq_accession)
...
class OperonSerializer(BaseSerializer, PositionMixInSerializer):
    ...
    name = serializers.CharField(max_length=50, help_text=help_text.operon_name)
    function = serializers.CharField(max_length=250, help_text=help_text.operon_function)
...
class OrganismSerializer(BaseSerializer):
    ...
    ncbi_taxonomy = serializers.IntegerField(help_text=help_text.ncbi_taxonomy)
    species = serializers.CharField(max_length=150, help_text=help_text.species)
    strain = serializers.CharField(max_length=150, help_text=help_text.strain)
    refseq_accession = serializers.CharField(max_length=50, help_text=help_text.refseq_accession)
    refseq_ftp = serializers.CharField(max_length=250, help_text=help_text.refseq_ftp)
    genbank_accession = serializers.CharField(max_length=50, help_text=help_text.genbank_accession)
    genbank_ftp = serializers.CharField(max_length=250, help_text=help_text.genbank_ftp)
    ncbi_assembly = serializers.IntegerField(help_text=help_text.ncbi_assembly)
...
class Publication(BaseSerializer):
    ...
    doi = serializers.CharField(max_length=250, help_text=help_text.doi)
    title = serializers.CharField(max_length=500, help_text=help_text.title)
    author = serializers.CharField(max_length=250, help_text=help_text.author)
...
class RegulatorSerializer(BaseSerializer, GeneMixInSerializer, SequenceMixInSerializer, PositionMixInSerializer):
    # properties
    mechanism = serializers.CharField(required=True, choices=choices.mechanism,
...
class RegulatoryInteraction(BaseSerializer):
    ...
    tfbs = serializers.CharField(max_length=100, help_text=help_text.tfbs_id)
    effector = serializers.CharField(max_length=100, help_text=help_text.effector_id)
    regulatory_effect = serializers.CharField(required=True, choices=choices.regulatory_effect,
